...
import xyz.wendelsegadilha.cursonelioalves.dto.ClienteDTO;
...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possível excluir porque existem pedido(s) relacionado(s)");
		}
	}
	...
	public Page<Cliente> findPage(Integer page, Integer size, String direction, String order) {
